...
const Input: React.FC<InputProps> = ({
  ...
  const inputStyles = separateTextClassNames(
    twMerge(
      "p-3 border border-gray-200 dark:border-gray-500 rounded-md w-full text-[14px] placeholder:text-[#8f8f8f] placeholder:text-[14px] dark:text-[#cfcfcf] text-[#000] dark:text-[#fff]",
